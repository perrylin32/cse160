...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        var x = (other1.elements[1] * other2.elements[2]) - (other1.elements[2] * other2.elements[1]);
        var y = -((other1.elements[0] * other2.elements[2]) - (other1.elements[2] * other2.elements[0]));
        var z = (other1.elements[0] * other2.elements[1]) - (other1.elements[1] * other2.elements[0]);
